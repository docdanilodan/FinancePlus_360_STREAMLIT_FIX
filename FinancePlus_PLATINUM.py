"""F_P_PLATINUM V_1.1 - Streamlit entrypoint.
...
def render_sidebar() -> None:
    with st.sidebar:
        ...
        st.markdown("---")
        st.caption(f"PLATINUM V_{APP_VERSION} · Core {LEGACY_APP_VERSION}")


def render_home() -> None:
    st.header("💎 F_P_PLATINUM V_1.1")
    st.markdown(
